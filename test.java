...
public class test {
    ...
    public static void main(String[] args) {
        ...
        //ACCESSING fullList ( LinkedList<LinkedList<String>> )
            System.out.println("\nACCESSING fullList");
            ...
            for(int i = 0;i<fullList.size();i++){ //Selects and loop every name in every linkedList
                ...
                nameList.add(fullList.get(i).get(0));
            }
        ...
        // UPDATING on fullList
            ...
            fullList.set(1,update); //NOTE: arguments: .set(int index, var value)
            System.out.println(fullList);
        // REMOVING on fullList
            System.out.println("REMOVING fullList");
            fullList.remove(1); //NOTE: index needed
            System.out.println(fullList);
        //SORTING on FullList
            Collections.sort(nameList); //auto Sort
            System.out.println(nameList);
        //NOTE: we'll use bubble sort for simplest sorting algorithm
        ...
        //ACCESSING fullList2 ( LinkedList<HashMap<String,String>> )
            System.out.println("\nACCESSING fullList2");
